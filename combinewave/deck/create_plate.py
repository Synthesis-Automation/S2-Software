...
if __name__ == "__main__":
    ...
    my_plate = Plate(name='tiprack_1000uL', grid=(12, 8), offset=(
        14.3, 11.2), spacing=(9, 9), diameter=4.20, depth=0, height=10, volume=0)
    my_plate.creat_plate()
    my_plate.save_plate_file()
    ...
    my_plate = Plate(name='plate_2mL', grid=(8, 6), offset=(
        10, 10), spacing=(14.2, 13.2), diameter=11.7, depth=31.6, height=50.6, volume=1500)
    my_plate.creat_plate()
    my_plate.save_plate_file()
    ...
    my_plate = Plate(name='plate_15mL', grid=(4, 3), offset=(
        10, 10), spacing=(24, 24), diameter=18.0, depth=75, height=103, volume=4000)
    my_plate.creat_plate()
    my_plate.save_plate_file()
    ...
    my_plate = Plate(name='workup_small', grid=(4, 3), offset=(
        10, 10), spacing=(30.5, 28.5), diameter=21.0, depth=50.0, height=115.0, volume=4000)
    my_plate.creat_plate()
    my_plate.save_plate_file()
    ...
    my_plate = Plate(name='plate_8mL', grid=(4, 3), offset=(
        28, 20), spacing=(24.0, 24.5), diameter=18.0, depth=59, height=86.5, volume=4000)
    my_plate.creat_plate()
    my_plate.save_plate_file()
